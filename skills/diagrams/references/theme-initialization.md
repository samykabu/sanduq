...
Use this when the user wants to initialize or refresh Diagram Design colors from a local design system document, for example `design.md`, `system-design.md`, `system design.md`, `brand.md`, or `docs/design-system.md`.
...
- "Refresh Schematic from our design system file."
...
Diagram Design has a small semantic palette. Map broad design-system tokens into these roles:
