...
- [ ] T044 [P] [US1] Generate Illustrate sequence HTML and PNG assets for the password reset interaction in frontend/public/how-to-test/assets/user-management/diagrams/user-management-password-reset-sequence.html
