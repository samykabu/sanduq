---
name: diagram-design
description: Create and export technical or product diagrams in 27 formats—including architecture, IT current-state, flowchart, sequence, state machine, ER, timeline, swimlane, quadrant, radar, loop, nested, tree, org chart, layers, venn, pyramid, bar, line, Gantt, scatter, high-level, process, medallion, data flow, DP integration, and DP security matrix—as standalone HTML with inline SVG plus optional SVG/PNG exports. Use for diagram generation, visual variants, brand/theme onboarding, and diagram export. Includes light, dark, full editorial, generated hand-drawn, terminal, consultant, icon, and annotation capabilities.
---
