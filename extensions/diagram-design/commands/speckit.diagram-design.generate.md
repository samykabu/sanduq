---
description: "Generate the most appropriate technical or product diagram using the versioned Diagram Design skill package."
---

# Generate a Diagram

Use the installed, versioned Diagram Design package to create a diagram for the user's request.
...
1. Read `.specify/extensions/diagram-design/skill/SKILL.md` completely before generating anything.
2. Resolve every relative `references/`, `assets/`, and `scripts/` path against
   `.specify/extensions/diagram-design/skill/`.
...
hand-drawn, terminal, consultant quadrant, icon, and annotation variants. Every core type has a
committed `example-<type>-hand.html` reference.
